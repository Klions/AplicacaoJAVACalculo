...
public class Prender extends javax.swing.JFrame {
    ...
    public Prender() {
        ...
        jPanel2.setBackground(new java.awt.Color(50, 31, 87));
        jPanel3.setBackground(new java.awt.Color(50, 31, 87));
        jPanel4.setBackground(new java.awt.Color(50, 31, 87));
        jPanel5.setBackground(new java.awt.Color(50, 31, 87));
        jPanel6.setBackground(new java.awt.Color(50, 31, 87));
        jPanel7.setBackground(new java.awt.Color(50, 31, 87));
        jPanel8.setBackground(new java.awt.Color(50, 31, 87));
        jPanel9.setBackground(new java.awt.Color(50, 31, 87));
        jPanel10.setBackground(new java.awt.Color(50, 31, 87));
        jPanel11.setBackground(new java.awt.Color(50, 31, 87));
    ...
    public boolean AtualizarCrimes(){
        ...
        for (int i=1; i<=tamanhototal; i++) {
            ...
            if(valorc > 0){
                if(crimestotais>0){CrimesTxt = CrimesTxt+" +";}
                ...
                if(i == 16){ // SISTEMA DE DROGAS
                    if(valorc < 6){
                       ...
                       valormulta = valormulta+    500;
                        ...
                        CrimesTxt = CrimesTxt+" Posse de Drogas"; 
                        valormeses = valormeses+    10;
                        valormulta = valormulta+    1000;
                    }else if(valorc > 10){
                        CrimesTxt = CrimesTxt+" Tráfico de Drogas"; 
                        valormeses = valormeses+    15;
                        valormulta = valormulta+    2500;
                        ValorVezes =    2;
                        QntVezes   =    10;
                    }
                }else{
                    valormulta = valormulta+ValordaMulta; //*valorc);
                    valormeses = valormeses+ValorMeses;//*valorc;
                    CrimesTxt = CrimesTxt+" "+NomeCrimes;
                }
                crimestotais++;
                if(valorc>1){CrimesTxt = CrimesTxt+"(x"+valorc+")";}
                int valorconta=0;
                if(ValorVezes > 0){
                ...
                valormeses = valormeses+valorconta;
            }
            //CamposTexto(i).setText(valorc+"");
        }
        String Beneficios="";
        if(desacato){
            valormeses=valormeses*2;
            check1.setSelected(false);
            check3.setSelected(false);
            check4.setSelected(false);
            check5.setSelected(false);
            check6.setSelected(false);
            Beneficios=Beneficios+" / Desacato [REVOGADO TODAS AS REDUÇÕES]";
        }
        
        //CONTA DOS BENEFICIOS
        if(check1.isSelected()){valormeses=valormeses-((valormeses*30)/100);Beneficios=" / Réu Primario [-30%]";                       }//-30%
        if(check2.isSelected()){valormeses=valormeses+((valormeses*30)/100);Beneficios=Beneficios+" / Réu Reincidente [+30%]";         }//+30%
        if(check3.isSelected()){valormeses=valormeses/2;Beneficios=Beneficios+" / Cúmplice [-50%]";                                    }//50% da pena
        if(check4.isSelected()){valormeses=valormeses-((valormeses*10)/100);Beneficios=Beneficios+" / Confessou crime [-10%]";         }//-10%
        if(check5.isSelected()){valormeses=valormeses-((valormeses*15)/100);Beneficios=Beneficios+" / Delação Premiada [-15%]";        } //-15%
        if(check6.isSelected()){valormeses=valormeses-((valormeses*10)/100);Beneficios=Beneficios+" / Negociação com advogado [-10%]"; } //-10%
        if(resistenciaprisao){  valormeses=valormeses+((valormeses*30)/100);Beneficios=Beneficios+" / Resistência à prisão [+30%]"; } //-10%
        //desacato
        ...
        if(CrimesTxt.length() <= 0){ CrimesTxt="Nenhuma";}
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CRIMES E PRISÃO LSPD ORIGIN");
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addComponent(discord, javax.swing.GroupLayout.DEFAULT_SIZE, 353, Short.MAX_VALUE)
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanel4Layout.createSequentialGroup()
                .addComponent(discord, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        check3.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        check4.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        check5.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        check5.setForeground(new java.awt.Color(255, 255, 255));
        check5.setText("DELAÇÃO PREMIADA");
        ...
        check6.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(check3, javax.swing.GroupLayout.PREFERRED_SIZE, 145, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        txtA26.setFont(new java.awt.Font("Tahoma", 0, 10)); // NOI18N
        txtA26.setForeground(new java.awt.Color(255, 255, 255));
        txtA26.setText("ARMAS/MUNIÇÕES:");
